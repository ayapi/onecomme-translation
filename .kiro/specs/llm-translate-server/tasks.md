...
- [ ] 2.2 (P) YAML設定ファイルと環境変数から設定を読み込むローダーを実装する
...
- [ ] 3. 翻訳サービスの実装
- [ ] 3.1 Vercel AI SDKを使った翻訳サービスのコアロジックを実装する
...
- [ ] 3.3 LLM APIのタイムアウトとエラーハンドリングを実装する
